...
//SelectedButtonFunctionality - As the buttons are selected, the image changes to signify this and activates the sound to playback at a given tempo.
...
function playSound(soundfile) {
  document.getElementById("ambaudio").innerHTML=
    "<embed src=\""+soundfile+"\" hidden=\"true\" autostart=\"true\" loop=\"tue\" />";
}
